...
<main id="contact">
	<div class="container">
		<div class="form-container">
			...
			<form id="contact-form" method="POST" name="contact-form" data-netlify="true">
		...
		<div class="info">
			<ul>
				<li>
					<p>Phone:</p>
					<a href="/">+1 (918) 000-0000</a>
				</li>
				<li>
					<p>Email:</p>
					<a href="/">business@email.com</a>
				</li>
				<li>
					<p>Business Hours:</p>
				...
				<li>
					...
					<a href="/">1234 East Tulsa, St. 74110</a>
				</li>
			</ul>
			<div class="map">
				<iframe
